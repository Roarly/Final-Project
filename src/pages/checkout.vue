...
<template>
  <div class="pt-32">
    ...
    <div class="order-first col-span-1 pt-10 lg:col-span-4 lg:order-last">
      <h4 class="mb-5 text-3xl text-gray-700">Order Summary</h4>
      <div class="p-10 bg-white rounded-md shadow-md"></div>
    </div>
  </div>
</template>
